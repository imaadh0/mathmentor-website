        ...
        <div className="w-full relative -mt-24 sm:-mt-28 md:-mt-32 lg:-mt-72 xl:-mt-80 2xl:-mt-96 pt-4 pb-8 sm:pt-6 sm:pb-12 md:pt-8 md:pb-16 lg:pt-10 lg:pb-20 xl:pt-12 xl:pb-24 2xl:pt-14 2xl:pb-28">
            ...
            <div className="relative w-full">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center p-12 lg:p-16 xl:p-20 2xl:p-24">
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2" style={{ top: '45%' }}>
                  ...
                  >
                    Customized curriculum that adapts to your unique
                    learning style, pace and goal for optimal understanding
                  </p>
                </div>

                {/* Button - Lowered a lot more with negative margins */}
                <div className="mt-auto relative cursor-pointer hover:scale-105 transition-transform duration-200" style={{ marginBottom: '-2.5rem' }}>
                  <img
          ...
          <div className="hidden md:block lg:hidden relative overflow-hidden">
            ...
            <div className="relative w-full">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center p-6 md:p-8">
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2" style={{ top: '42%' }}>
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 cursor-pointer hover:scale-105 transition-transform duration-200" style={{ bottom: '8%' }}>
                  <img
                    src="/About/modern-card-button.png"
                    alt="Start Free Trial button"
          ...
          <div className="md:hidden relative overflow-hidden">
            ...
            <div className="relative w-full">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center px-4 sm:px-6" style={{ paddingTop: '45%', paddingBottom: '0%' }}>
                {/* Main Heading */}
                <h2
